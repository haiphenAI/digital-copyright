...
var ReadableScan = /*#__PURE__*/function (_Readable) {
  _inherits(ReadableScan, _Readable);

  var _super = _createSuper(ReadableScan);
  ...
  _createClass(ReadableScan, [{
    ...
    value: function _read() {
      ...
      this._callScan().then(function (res) {
        ...
        if (keys.length > 0) _this2.push(keys);else _this2._read();
      }).catch(function (err) {
